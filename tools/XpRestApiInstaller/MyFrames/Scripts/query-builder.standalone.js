...
(function (root, factory) {
    ...
    QueryBuilder.OPERATORS = {
        ...
        is_true: { type: 'is_true', nb_inputs: 0, multiple: false, apply_to: ['string'] },
        is_false: { type: 'is_false', nb_inputs: 0, multiple: false, apply_to: ['string'] },
        /*bitwise_and: { type: 'bitwise_and', nb_inputs: 1, multiple: false, apply_to: ['number', 'string'] },*/
        bit_set: { type: 'bit_set', nb_inputs: 1, multiple: false, apply_to: ['number', 'string'] },
        bit_cleared: { type: 'bit_cleared', nb_inputs: 1, multiple: false, apply_to: ['number', 'string'] },
...
<div id="{{= it.group_id }}" class="rules-group-container"> \
  <div class="rules-group-header"> \
    <div class="btn-group pull-right group-actions"> \
      <button type="button" class="btn-qb-add btn-qb-add-rule" title="Add Rule"  data-add="rule"> \
        <!--<i class="{{= it.icons.add_rule }}"></i> {{= it.translate("add_rule") }}--> \
      </button> \
      {{? it.settings.allow_groups===-1 || it.settings.allow_groups>=it.level }} \
        <button type="button" class="btn-qb-add btn-qb-add-group" title="Add Group" data-add="group"> \
          <!--<i class="{{= it.icons.add_group }}"></i> {{= it.translate("add_group") }} --> \
        </button> \
      {{?}} \
      {{? it.level>1 }} \
        <button type="button" class="btn-qb-delete" title="Delete Rule" data-delete="group"> \
...
<div id="{{= it.rule_id }}" class="rule-container"> \
  <div class="rule-header"> \
    <div class="btn-group pull-right rule-actions"> \
      <button type="button" class="btn-qb-delete" title="Delete Rule" data-delete="rule"> \
