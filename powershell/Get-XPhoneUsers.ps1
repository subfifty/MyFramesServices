...
$query = 
@"
    SELECT TOP (10) col_c4bAtlas_user_accountName as AccountName, col_givenName as FirstName, col_sn as LastName, col_mail as Email 
    FROM t_person 
    WHERE col_c4bAtlas_user_isAdmin = 'False' AND col_c4bAtlas_user_internalUser = 'False' AND col_c4bAtlas_user_loginMode > 0
"@
